...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [434],
  {
    6431: function (t, e, n) {
            ...
            var d,
              ...
              to =
                ...
                (j =
                  ...
                  ? j + "-" + O
                  : O);
            t = s.__assign(s.__assign({}, t), { layoutId: to });
      ...
      var tA = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
        tS = { offset: "strokeDashoffset", array: "strokeDasharray" };
      function tb(t, e, n, r) {
        var i,
          o,
          a,
        ...
        eo = {
          inView: ei(function (t) {
            var n = t.visualElement,
              ...
              a = t.viewport,
              l = void 0 === a ? {} : a,
              c = u.useRef({ hasEnteredView: !1, isInView: !1 }),
              d = !!(r || i || o);
      ...
      var ed = function (t) {
        ...
        e_ = function (t, e) {
          var n;
          return (
            (n = tM(e) ? ey : ex[t] || ex.default), s.__assign({ to: e }, n(e))
          );
        },
          ...
          return (
            ...
            (t.prototype.resolveConstraints = function () {
              ...
              u && I(u)
                ...
                ? (this.constraints =
                    ...
                    (r = u.bottom),
                    (i = u.right),
                    { x: nt(t.x, n, i), y: nt(t.y, e, r) }))
                : (this.constraints = !1),
                (this.elastic =
                  (void 0 === (o = l) && (o = 0.35),
                  !1 === o ? (o = 0) : !0 === o && (o = 0.35),
                  { x: nn(o, "left", "right"), y: nn(o, "top", "bottom") })),
                d !== this.constraints &&
                  c &&
                  this.constraints &&
            ...
            (t.prototype.resolveRefConstraints = function () {
              ...
              var o =
                  ...
                  u),
                a = { x: ne((d = i.layout.actual).x, o.x), y: ne(d.y, o.y) };
              if (n) {
                var s,
                  u,
                  c,
          ...
          pan: ei(function (t) {
            ...
            u.useEffect(function () {
              ...
              tJ(
                ...
                (e || n || r || i) &&
                  function (t) {
                    a.current = new eJ(t, l, { transformPagePoint: s });
                  }
              ),
              t9(function () {
      ...
      var nF = function (t, e) {
        ...
        nZ = function (t, e) {
          return J(t)
            ? nG(e, { enableHardwareAcceleration: !1 })
            : nW(e, { enableHardwareAcceleration: !0 });
        };
      function nK(t, e) {
            ...
            (t.prototype.applyTransform = function (t, e) {
              ...
              for (var r = 0; r < this.path.length; r++) {
                ...
                !e &&
                  ...
                  i.scroll &&
                  i !== i.root &&
                  n_(n, { x: -i.scroll.x, y: -i.scroll.y }),
                        ...
                        (s = (a = n[l]).projectionDelta),
                          (null ===
                            ...
                            (r &&
                              ...
                              a.scroll &&
                              a !== a.root &&
                              n_(t, { x: -a.scroll.x, y: -a.scroll.y }),
                            s &&
                              ((e.x *= s.x.scale),
                              (e.y *= s.y.scale),
                              nh(t, s)),
      ...
      var rV = { duration: 0.45, ease: [0.4, 0, 0.1, 1] };
      function rC(t, e) {
                  ...
                  value: {
                    ...
                    registerItem: function (t, e) {
                      e &&
                        ...
                        (m.push({ value: t, layout: e[a] }), m.sort(rJ));
                    },
      ...
      var r4 = u.forwardRef(function (t, e) {
        ...
        r9 = s.__assign(s.__assign({ renderer: nZ }, eq), eo),
        ...
        var t = !1,
          ...
          r = {
            ...
            start: function (r, i) {
              ...
              return (
                n.forEach(function (t) {
                  o.push(eY(t, r, { transitionOverride: i }));
                }),
                Promise.all(o)
              );
            },
        ...
        il = nT({
          ...
          makeTargetAnimatable: function (t, e) {
            var n = e.transition,
              ...
              o = ez(i, n || {}, t);
            return (
              eN(t, i, o), s.__assign({ transition: n, transitionEnd: r }, i)
            );
          },
        }),
        ic = tj({ scrapeMotionValuesFromProps: iu, createRenderState: iu }),
        id = function (t) {
      ...
      (e.AnimatePresence = function (t) {
        ...
        return (
          ...
          (g = g.map(function (t) {
            ...
            return x.has(e)
              ...
              : h.createElement(
                  rB,
                  { key: rz(t), isPresent: !0, presenceAffectsLayout: d },
                  t
                );
          })),
          "production" !== y &&
        ...
        (e.createDomMotionComponent = function (t) {
          return K(tN(t, { forwardMotionProps: !1 }, rI, nZ, rM));
        }),
        ...
        (e.useDeprecatedAnimatedState = function (t) {
          var e = s.__read(u.useState(t), 2),
            ...
            i = ic({}, !1),
            o = Y(function () {
              return il({ props: {}, visualState: i }, { initialState: t });
            });
          return (
            u.useEffect(
              function () {
