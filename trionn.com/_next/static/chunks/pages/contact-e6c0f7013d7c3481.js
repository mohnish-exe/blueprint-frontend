  ...
  [335],
  {
    ...
    4589: function (e, s, t) {
      ...
      var l = t(5893),
        ...
        f = t(7423),
        N = (e) => {
          let { defaultPlaceholder: s, id: t, children: a } = e;
          return (0, l.jsx)("div", {
      ...
      function C(e) {
        let {
          ...
          [I, E] = (0, a.useState)({ success: "", fail: "" }),
          [L, A] = (0, a.useState)({ success: "", fail: "" });
        (0, b.L)(() => {
          o();
        }, [j]);
        let B = (e, s) => {
          ...
          O = (e) => {
            e.persist(), P({ ...D, [e.target.name]: e.target.value });
          },
          $ = async () => {
            (
              await fetch("/api/sendmailcontact", {
                method: "POST",
                body: JSON.stringify({ contactField: D }),
                headers: { "Content-Type": "application/json" },
              })
            ).ok
              ? (E({ ...I, success: "We will get in contact soon.", fail: "" }),
                P({
                  ...D,
                  name: "",
                  email: "",
                ...
                document
                  .querySelectorAll("#contactForm .field")
                  .forEach((e) => {
                    void 0 !== e.childNodes[1] &&
                      e.childNodes[1].classList.remove("filled");
                  }),
                setTimeout(() => {
                  E({ ...I, success: "", fail: "" });
                }, 5e3))
          ...
          q = (e) => {
            e.persist(), U({ ...Z, [e.target.name]: e.target.value });
          },
          F = async () => {
            (
              await fetch("/api/sendmailgetquote", {
                method: "POST",
                body: JSON.stringify({ getQuoteField: Z, dropDownValue: i }),
                headers: { "Content-Type": "application/json" },
              })
            ).ok
              ? (A({
                ...
                document
                  .querySelectorAll("#getQuoteForm .field")
                  .forEach((e) => {
                    void 0 !== e.childNodes[1] &&
                      e.childNodes[1].classList.remove("filled");
                  }),
                document
                  .querySelectorAll(".tr__custom__select")
                  .forEach((e) => {
                    e
                      .querySelector(".select-dropdown__button")
                      .setAttribute("data-value", ""),
                      e
                        .querySelector(".selected-dropdown__list-item")
                        .classList.remove("filled"),
                      (e.querySelector(
                        ".selected-dropdown__list-item"
                      ).innerHTML = e.querySelector(
                        "ul.select-dropdown__list > li:first-child"
                      ).innerHTML);
                  }),
                setTimeout(() => {
                  A({ ...L, success: "", fail: "" });
        ...
        function G(e) {
          if (window.innerWidth > 1024) {
            ...
            u.ZP.to(s, 1, {
              x: ((e.clientX - t.left) / s.offsetWidth - 0.5) * 50,
              y: ((e.clientY - t.top) / s.offsetHeight - 0.5) * 50,
              ease: p.Yp.easeOut,
            });
          }
        }
            ...
            children: [
              (0, l.jsxs)(r(), {
                children: [
                  ...
                  (0, l.jsx)("title", { children: "TRIONN | Contact Us" }),
                  (0, l.jsx)(
                    "meta",
                    {
                      name: "description",
                      content:
                        "Trionn\xae - Your Design, Development, and Branding Partner in Rajkot, Gujarat, India.",
                    },
                    "desc"
                  ),
                  (0, l.jsx)("meta", {
                  ...
                  (0, l.jsx)("meta", {
                    property: "og:url",
                    content: "https://trionn.com/contact",
                  }),
                  (0, l.jsx)("meta", {
                    property: "og:title",
              ...
              (0, l.jsxs)(f.Z, {
                children: [
                  v.bannerData.contactBanner.title &&
                    (0, l.jsx)(g.Z, {
                      type: "h1",
                      customClass: "small",
                      children: v.bannerData.contactBanner.title.map((e, s) =>
                        (0, l.jsx)(
                          a.Fragment,
                          {
                            children: (0, l.jsx)("span", { children: e.data }),
                          },
                          s
                        )
                      ),
                    }),
                  v.bannerData.contactBanner.content &&
                    (0, l.jsx)("p", {
                      className: "mt-4 tr__banner__fadeUp",
                      children: v.bannerData.contactBanner.content.map((e, s) =>
                        (0, l.jsx)(
                          a.Fragment,
                          {
                            children: (0, l.jsx)("span", { children: e.data }),
                  ...
                  (0, l.jsx)("div", {
                    ...
                    children: (0, l.jsx)(d(), {
                      ...
                      onClick: (e) => n(e, ".tr__contact__forms"),
                      children: (0, l.jsx)(
                        c(),
                        {
                          src: "true" == s ? y.Z : w.Z,
              ...
              (0, l.jsx)("section", {
                ...
                children: (0, l.jsxs)("div", {
                  className:
                    "tr__tabs__wrapper tr__container lg:max-w-3xl 2xl:max-w-6xl",
                  children: [
                    (0, l.jsxs)("div", {
                      className: "tr__tabs",
                      children: [
                          ...
                          (0, l.jsx)("form", {
                            onSubmit: (e) => {
                              ...
                              let s = {},
                                t = !0;
                              (null == D.name || "" == D.name) &&
                                ((s.name = "Please enter your name"), (t = !1)),
                                null == D.email || "" == D.email
                                  ? ((s.email = "Please enter your email"),
                                    (t = !1))
                                  : /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(
                                      D.email
                                    ) ||
                                    ((s.email = "Invalid email address"),
                                    (t = !1)),
                                (null == D.message || "" == D.message) &&
                                  ((s.message = "Please enter your message"),
                                  (t = !1)),
                                t ? $() : P({ ...D, error_list: s });
                            },
                            id: "contactForm",
                              ...
                              children: [
                                ...
                                (0, l.jsxs)("li", {
                                  ...
                                  children: [
                                    ...
                                    (0, l.jsx)("textarea", {
                                      placeholder:
                                        "Ex. Hello, Trionn Design. We need help to make this project unique.",
                                      value: D.message || "",
                                      onChange: O,
                                      onBlur: z,
                                      name: "message",
                                    }),
                                    D.error_list.message &&
                                      (0, l.jsx)("div", {
                                        className: "field_error",
                            ...
                            onSubmit: (e) => {
                              ...
                              (null == Z.name || "" == Z.name) &&
                                ...
                                (null == i.project_type ||
                                  ...
                                  (t = !1)),
                                (null == i.project_budget ||
                                  "" == i.project_budget) &&
                                  ((s.project_budget =
                                    "Please enter project budget"),
                                  (t = !1)),
                                (null == Z.message || "" == Z.message) &&
                                  ((s.message = "Please enter project message"),
                                  (t = !1)),
                                t ? F() : U({ ...Z, error_list: s });
                            },
                            id: "getQuoteForm",
                            children: (0, l.jsxs)("ul", {
                              children: [
                      ...
                      children: [
                          ...
                          children: [
                            (0, l.jsxs)("div", {
                              children: [
                                ...
                                (0, l.jsx)("span", {
                                  className:
                                    "text-2xl opacity-70 mb-2 block 2xl:hidden",
                                  children: "Location",
                                }),
                              ],
                            }),
                            (0, l.jsx)(g.Z, {
                              type: "h4",
                              content:
                                'TRIONN<sup class="text-base">&reg;</sup> <br class="hidden sm:block" /><br />216 - 217 4Plus Complex <br />Astron chowk, Rajkot 01 <br />Gujarat, India.',
                            }),
                          ],
                        }),
                        (0, l.jsx)("div", {
                          ...
                          children: [
                            (0, l.jsxs)("div", {
                              children: [
                                ...
                                (0, l.jsx)("p", {
                                  className:
                                    "text-2xl opacity-70 mt-4 mb-2 block 2xl:hidden",
                                  children: "Email",
                                }),
                              ],
                            }),
                        ...
                        (0, l.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, l.jsx)("h4", {
                              className: "overflow-visible",
                              children: (0, l.jsx)(d(), {
                                href: "https://teams.live.com/l/invite/FEAyRbepvsvnUG_8QE",
                                className:
                                  "tr__cursor__hoverable tr__magnetic inline-block",
                                children: "Talk to Trionn",
                              }),
                            }),
                          ],
                        }),
                        ...
                        (0, l.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, l.jsxs)("h4", {
                              className:
                                "overflow-visible space-x-2 2xl:space-x-4",
                              children: [
                                (0, l.jsx)(d(), {
