    ...
    4990: function (e, s, t) {
      ...
      var p = t(4712),
        ...
        b = {
          ...
          width: 2880,
          blurDataURL:
            "data:image/webp;base64,UklGRkYAAABXRUJQVlA4IDoAAACwAQCdASoIAAUAAkA4JYwCdADze7UQAP71/EErqx7zdE38NxNBGLHToYFG/MtYU6SEm0LW4BQlfAAA",
          blurWidth: 8,
          blurHeight: 5,
        };
      function w(e) {
        ...
        return (
                  ...
                  x: function () {
                    return (
                      -(
                        ...
                        (window.innerWidth -
                          document.querySelector(".tr__container")
                            .clientWidth) +
                        document.querySelector(".tr__header__left").offsetLeft
                      ) + "px"
                    );
                  },
                  ease: "none",
          ...
          (0, i.useEffect)(() => {
            ...
            d.ZP.utils.toArray(".tr__process__step").forEach((s, t) => {
              d.ZP.to(s, {
                display: "flex",
                scrollTrigger: { trigger: e, markers: !1, scrub: !1 },
              });
            });
            let s = document.querySelector(".tr__circular__talknow");
            d.ZP.set(s, { autoAlpha: 0, xPercent: 100 }),
              d.ZP.to(s, {
                xPercent: 0,
                autoAlpha: 1,
                duration: 0.5,
            ...
            children: [
              (0, r.jsxs)(a(), {
                children: [
                  ...
                  (0, r.jsx)("title", { children: "TRIONN | Services" }),
                  (0, r.jsx)(
                    "meta",
                    {
                      name: "description",
                      content:
                        "Trionn\xae - Expertise in Website, Mobile App, Web App, and Software Design and Development Services.",
                    },
                    "desc"
                  ),
                  (0, r.jsx)("meta", {
              ...
              (0, r.jsxs)(x.Z, {
                children: [
                  v.bannerData.servicesBanner.title &&
                    (0, r.jsx)(p.Z, {
                      type: "h1",
                      customClass: "small",
                      children: v.bannerData.servicesBanner.title.map((e, s) =>
                        (0, r.jsx)(
                          i.Fragment,
                          {
                            children: (0, r.jsx)("span", { children: e.data }),
                          },
                          s
                        )
                      ),
                    }),
                  v.bannerData.servicesBanner.content &&
                    (0, r.jsx)("p", {
                      className: "mt-4 tr__banner__fadeUp",
                      children: v.bannerData.servicesBanner.content.map(
                        (e, s) =>
                          (0, r.jsx)(
                            i.Fragment,
                            {
                ...
                children: [
                  (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)(p.Z, {
                      type: "h2",
                      content:
                        'In the wild digital realm, we craft <br class="hidden sm:block" />products that roar with user <br class="hidden sm:block" />friendly innovation.',
                    ...
                    (0, r.jsxs)("div", {
                      ...
                      children: [
                        (0, r.jsx)(p.Z, {
                          type: "h2",
                          content:
                            "We're here to make tech businesses roar in the digital jungle, crafting valuable impact through design, branding, and development services.",
                          customClass: "tr__heading__animation mb-10",
                        }),
                        (0, r.jsx)("p", {
                          className: "w-full lg:w-6/12 ml-auto pl-1 tr__fadeUp",
                          children:
                            "Challenges are the soil where our growth blossoms. Armed with digital prowess, we fearlessly overcome them. Bring your branding, web design, and creative challenges; our lionhearted approach will leave a lasting impression.",
                        }),
                      ],
                    }),
                    (0, r.jsx)("div", {
                                  ...
                                  children: [
                                    ...
                                    (0, r.jsxs)("div", {
                                      ...
                                      children: [
                                        ...
                                        (0, r.jsxs)("div", {
                                          className:
                                            "tr__services__block pt-10 pb-0",
                                          children: [
                                            (0, r.jsx)("div", {
                                              className:
                                                "tr__services__block__left",
                                              children:
                                                e.lists &&
                                                e.lists.left.map((e, s) =>
                                                  (0, r.jsx)(
                                                    i.Fragment,
                                                    {
                                                      children: (0, r.jsx)(
                                            ...
                                            (0, r.jsx)("div", {
                                              className:
                                                "tr__services__block__right",
                                              children:
                                                e.lists &&
                                                e.lists.right.map((e, s) =>
                                                  (0, r.jsx)(
                                                    i.Fragment,
                                                    {
                                                      children: (0, r.jsx)(
              ...
              (0, r.jsxs)("section", {
                ...
                children: [
                  ...
                  (0, r.jsxs)("h4", {
                    className:
                      "tr__heading__animation -mt-16 mb-20 tr__container",
                    children: [
                      "These pillars support excellence ",
                      (0, r.jsx)("br", {}),
